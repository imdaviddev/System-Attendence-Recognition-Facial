...
export const state = observable({
  institutos: [
    {
      ...
      lugares: [
        { id: 7, nombre: "Modulo 7", descripcion: "Clases en general" },
        { id: 3, nombre: "Modulo 3", descripcion: "Clases en general" },
      ],
      isActive: true
    },
    {
      ...
      lugares: [
        { id: 7, nombre: "Modulo 7", descripcion: "Clases en general" },
        { id: 3, nombre: "Modulo 3", descripcion: "Clases en general" },
        { id: 5, nombre: "Modulo 5", descripcion: "Clases en general" },
      ],
      isActive: true
    },
    {
  ...
  categorias: [
    ...
    { id: 3, nombre: "Personal de Coca Cola", descripcion: "Personal que corresponde a la empresa coca cola", isActive: true  }
  ],
  id_categorias: { id: 4 },
  ...
  visitantes: [
    {
      ...
      categoria: { 
          id: 1, 
          nombre: "interno", 
          descripcion: "Todos aquellos que pertenezcan en una elacion directa a la UNGS", 
          isActive: true
      },
      rol: "docente",
      isActive: true,
  ...
  excepciones: [
    { 
      id: 1, 
      nombre: "EVENTO 25 DE MAYO", 
      descripcion: "Se le solicita acceso permitido a los personales de Coca Cola",
      fechaInicio: "20/01/25",
      fechaCierre: "20/02/25",
      lugares: [
        { id: 6, nombre: "Modulo 6", descripcion: "Clases en general", isActive: true },
        { id: 7, nombre: "Modulo 7", descripcion: "Clases en general", isActive: true },
      ],
      categoria: { id: 3, nombre: "Personal de Coca Cola", descripcion: "Personal que corresponde a la empresa coca cola", isActive: true  },
      isActive: true,
    }
  ],
  id_excepciones: { id: 2 },
  ...
  logs: [
    {
      id: 1,
      nombre: "Creacion de todos los datos",
      fecha: "10/05/24",
      isActive: true,
    },
  ],
